...
abstract class StaticDataSource {
  static List<ProjectEntity> allProjects = [
    //* PharmAssist
    ProjectEntity(
      name: 'PharmAssist',
    ...
    ProjectEntity(
      name: 'Bedouin Trails',
      subName: '🏜 Tourism Management Dashboard - Flutter Web',
      description:
          "Bedouin Trails is a modern Flutter-based dashboard designed to streamline tourism and trip management operations. The platform enables administrators to efficiently manage bookings, users, and travel packages through a clean and responsive interface. It provides real-time insights into trip performance and user activity through dynamic analytics and reporting tools. Built with scalability in mind, the application leverages Provider for state management and GetIt for dependency injection, ensuring maintainability and modular architecture. The system enhances operational efficiency for tourism businesses by centralizing workflows and delivering a seamless management experience.\n\nTech: Flutter, Provider, GetIt, Dio, Hive, FL Chart, REST APIs, Responsive Web Design, and Data Visualization.",
      year: 2026,
      image: Assets.imagesBedouinTrails,
      isCompleted: true,
    ),
    ...
    ProjectEntity(
      name: 'Lockers System',
      subName: '🔐 Smart Locker Management System - Mobile & Dashboard',
      description:
          "Lockers System is a comprehensive smart solution for managing secure storage with multi-role access, including users, employees, and administrators. The platform consists of a mobile application and admin dashboards that enable users to reserve lockers, track usage, and manage access seamlessly. It integrates real-time location services using Google Maps and supports secure online payments through Paymob. The system is designed with scalability and performance in mind, utilizing Provider for state management and clean architecture principles. This solution improves operational control, enhances user experience, and digitizes traditional locker management workflows.\n\nTech: Flutter, Provider, Google Maps API, Paymob Integration, REST APIs, Hive, Dio, Role-Based Access Control, and Responsive Design.",
      year: 2025,
      image: Assets.imagesLockersSystem,
      isCompleted: true,
    ),
    ...
    ProjectEntity(
      ...
      isCompleted: true,
      linkedInLink: 'https://www.linkedin.com/posts/mahmoud-adel-ali-mohamed_flutter-flutterdeveloper-softwareengineering-activity-7436765407824363520-EU4z?utm_source=share&utm_medium=member_desktop&rcm=ACoAAD4c_DcBi2fNcI8zLTk-rF1cY0_yKNzytg8'
    ),
    ...
    ProjectEntity(
      name: 'Tic-Tac-Toe',
      subName:
          "⭕ X-O Master - Flutter Tic-Tac-Toe Game with Clean Architecture",
      description:
    ...
    ProjectEntity(
      ...
      gitHubLink:
          "https://github.com/Mahmoud-Adel-Ali/Quick-Mart-E-commerce-App",
      isCompleted: false,
      figmaLink:
  ...
  static List<SkillModel> mySkills = [
    SkillModel(label: "Flutter", svgImage: Assets.iconsFlutter),
    SkillModel(label: "Dart", svgImage: Assets.iconsDart),
    SkillModel(label: "Firebase", svgImage: Assets.iconsFirebase),
    SkillModel(label: "Git", svgImage: Assets.iconsGit),
    SkillModel(label: "MVVM", svgImage: Assets.iconsMvvm),
    SkillModel(label: "Clean Architcture", svgImage: Assets.iconsCleanArch),
    SkillModel(label: "Clean Code", svgImage: Assets.iconsCleanCode),
    SkillModel(label: "OOP", svgImage: Assets.iconsOop),
    SkillModel(
        label: "Solid Principles", svgImage: Assets.iconsSolidPrinciples),
    SkillModel(
        label: "State Management", svgImage: Assets.iconsStateManagement),
    SkillModel(label: "BloC", svgImage: Assets.iconsBloc),
    SkillModel(label: "Design Pattern", svgImage: Assets.iconsDesignPatterns),
    SkillModel(label: "Testing", svgImage: Assets.iconsTesting),
    SkillModel(label: "Debugging", svgImage: Assets.iconsDebugging),
  ];
}
